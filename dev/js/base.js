$(function() {
  ...
  function faqHeightAdjustment() {
    $(".faq").each( function() {
      var headerHeight = $(this).children("header").innerHeight(),
      contentHeight = $(this).children(".content").innerHeight();

      if($(this).hasClass("open")){
        $(this).css("max-height", headerHeight + contentHeight);
      } else {
        $(this).css("max-height", headerHeight);
      }
  ...
  ***************************************/
  ...
  $(".faq header").click( function(e) {
    e.preventDefault();
    $this = $(this).parent();
    var contentHeight = $this.children(".content").innerHeight(),
    headerHeight = $this.children("header").innerHeight()
    thisHeight = parseInt($this.css("max-height"), 10);

    console.log(headerHeight);
    if (!$this.hasClass("open")) {
      $this.velocity( { maxHeight: thisHeight + contentHeight }, { duration: 250 });
      $this.toggleClass("open");
    } else {
      $this.velocity( { maxHeight: headerHeight });
      $this.toggleClass("open");
      i=0;
    }
  });
